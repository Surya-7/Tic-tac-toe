...
/******************* TicTacToeBoard *********************************/
  ...
  TicTacToeBoard.prototype.updateBoard = function(board){
	this.board = new TicTacToeBoard(board).board;
  }
...
/******************* TicTacToeAIPlayer *********************************/
  ...
  TicTacToeAIPlayer.prototype.updateBoard = function(board){
	this.gameBoard = new TicTacToeBoard(board);
  }
